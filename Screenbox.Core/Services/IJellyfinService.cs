...
public interface IJellyfinService
{
    ...
    void Disconnect();
    Task<MusicLibrary> FetchMusicAsync(IProgress<JellyfinSyncProgress>? progress = null, CancellationToken cancellationToken = default);
    Task<VideosLibrary> FetchVideosAsync(IProgress<JellyfinSyncProgress>? progress = null, CancellationToken cancellationToken = default);
